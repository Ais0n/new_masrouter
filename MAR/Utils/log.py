...
# Ensure stderr uses UTF-8 on Windows (default is cp1252) so that
# emojis and box-drawing characters in log messages are not garbled.
...
def configure_logging(print_level: str = "INFO", logfile_level: str = "DEBUG", log_name:str = "log.txt") -> None:
    ...
    logger.add(MAR_ROOT / f'logs/{log_name}', level=logfile_level, encoding='utf-8')
